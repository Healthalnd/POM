...
public class Runner {
  ...
  public void f() {
	  ...
	  TakesScreenshot scrhot = ((TakesScreenshot)driver);
	  File Srcfile = scrhot.getScreenshotAs(OutputType.FILE);
	  File destination=new File("C:\\2017\\Study\\Sakthi.png");
	  try {
		org.apache.commons.io.FileUtils.copyFile(Srcfile, destination);
	} catch (IOException e) {
